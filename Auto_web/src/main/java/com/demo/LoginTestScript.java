...
public class LoginTestScript {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Sahithi", "Sahithi@gmail.com", "Sahithi@123");// get login data
		addDetailToRegisterForm(driver, "Sahithi@gmail.com", "Sahithi", "Sahithi@123");// get register data
